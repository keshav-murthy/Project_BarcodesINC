...
public class MyAssetsPage extends BasePage {
	...
	public void verifyAsset(String random) {
		...
		wait.forPage();
		js.clickElement(driver.findElement(By.xpath("//a[contains(text()," + "'" + random + "'" + ")]")));
	}
	...
	public String selectRandomAsset() {
		...
		String ignoredAssets = "12345 00001";
	...
	public void locationVerfication() {
		...
		if (location.size() > 0) {
			...
			System.out.println("There is no location mentioned for this Asset");
	}
}